...
# Taken from https://github.com/CoreElectronics/CE-PiicoDev-QMC6310-MicroPython-Module/blob/main/PiicoDev_QMC6310.py
...
class PiicoDev_QMC6310(object):
    ...
    def __init__(self, bus=None, freq=None, sda=None, scl=None, addr=_I2C_ADDRESS, odr=3, osr1=0, osr2=0, range=3000, sign_x=0, sign_y=1, sign_z=1, calibrationFile='calibration.cal', suppress_warnings=False):
        try:
            if compat_ind >= 1:
                pass
            else:
